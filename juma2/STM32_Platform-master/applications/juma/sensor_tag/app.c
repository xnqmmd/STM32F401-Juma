...
{
    jsensor_app_set_sensor(JSENSOR_TYPE_HUMITY_TEMP);//温湿度
    jsensor_app_set_sensor(JSENSOR_TYPE_PRESSURE);//压力
    jsensor_app_set_sensor(JSENSOR_TYPE_MOTION_6AXIS);//六轴
    jsensor_app_set_sensor(JSENSOR_TYPE_MAGNET);//磁力计
}
