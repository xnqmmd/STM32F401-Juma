...
static void read_XYWH_date(void* args);
...
static void read_XYWH_date(void* args)
{
		 JSensor_XYWH_Typedef *p = (JSensor_XYWH_Typedef *)args;
		 p->XYWH[1] = Pixy_Color_Inf.Pixy_Color_PosX & 0xff ;
	   p->XYWH[0] = (Pixy_Color_Inf.Pixy_Color_PosX &0xff00)>>8;
	   p->XYWH[3] = Pixy_Color_Inf.Pixy_Color_PosY & 0xff ;
	   p->XYWH[2] = (Pixy_Color_Inf.Pixy_Color_PosY &0xff00)>>8;
	   p->XYWH[5] = Pixy_Color_Inf.Pixy_Color_Width & 0xff ;
	   p->XYWH[4] = (Pixy_Color_Inf.Pixy_Color_Width &0xff00)>>8 ;
	   p->XYWH[7] = Pixy_Color_Inf.Pixy_Color_Height & 0xff ;
	   p->XYWH[6] = (Pixy_Color_Inf.Pixy_Color_Height &0xff00)>>8 ;
